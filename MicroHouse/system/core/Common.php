...
echo 'load ' . $class , "\n";
		...
		{
			if (file_exists($path.$directory.'/'.$class.EXT) || class_exists($prefix.$class))
			{
				$name = $prefix.$class;
		...
		if (file_exists(APPPATH.$directory.'/'.config_item('subclass_prefix').$class.EXT) || class_exists(config_item('subclass_prefix').$class))
		{
